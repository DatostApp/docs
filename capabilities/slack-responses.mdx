...
Response pages are scoped to your Datost organization. Users outside the org see an access-required prompt; users inside the org with pending access see a request-access flow. Query IDs are unguessable, but treat the URL as org-internal.
